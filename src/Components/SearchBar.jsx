...
const SearchBar = () => {
  ...
  return (
    <Paper component="form" onSubmit={handleSubmit} style={{display: "flex", alignItems: "center", border: "1px solid #e3e3e3", borderRadius: "20px", boxShadow: "none", background: "#ffffff", ml: "3rem", mr: {sm: 5}}}>
